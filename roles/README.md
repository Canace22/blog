...
- `AGENTS.md`：知识库（wiki）的维护规则——告诉 agent 怎么"长记忆"。
...
| `wiki-curator.md` | wiki 维护 | 自然语言指令 | 按 AGENTS.md 工作流操作 wiki/ |
...
- **保持短**：单文件 < 100 行，遵循 `AGENTS.md` "宁缺毋滥"原则——前沿模型可靠遵守的指令约 150-200 条，角色 prompt 占掉一份预算就少一份。
