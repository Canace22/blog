...
- [假设驱动 AI 调试（概念）](hypothesis-driven-ai-debugging.md)（`DEBUG.md` / `program.md` 等外化假设与证据）
...
- [假设驱动 AI 调试（概念）](hypothesis-driven-ai-debugging.md)
- [LLM 维护的知识库（概念）](llm-maintained-wiki.md)
- [编译式知识库（概念）](compiled-knowledge-vault.md)
- [LOP（面向大模型编程）模式（概念）](lop-patterns.md)
