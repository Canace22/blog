...
1–6 主要来自 [Gemini 对话摘要](../sources/gemini-rss-flowerss-telegram-selfhost.md)（**助手建议**，非厂商 SLA）；7–8 来自 [博文：RSS 推送到 TG 的可行性探索](../sources/rss-telegram-selfhost.md)（**个人实践**，需结合你方网络与镜像版本自行验证）。
