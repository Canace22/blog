...
另外，再补充一个点，之前跟训练模型的同事聊天，他提到说现在的 AI 其实是假智能，他只会已经出现过的东西，一些模型训练素材中没有的东西，你跟他怎么对话都是解决不了的，就算你给了他文档，他也是不会的，因为目前的大模型还没有办法真正做到自主学习。

对于我们编程来说，大部分经验我相信大模型都学习过，问题不大，不过不同模型训练素材不一样，效果肯定有差异。
