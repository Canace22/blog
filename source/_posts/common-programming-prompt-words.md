...
categories: '软技能与思考'
tags: 职业发展
description: '开发中常用词汇翻译和用法整理，方便日常查阅使用'
author: Canace
comments: true
toc: true
...
| Adapt | 适配 | “适配”在技术语境中常指软件、硬件或系统之间的兼容与调整，英文用 “adapt” 最简洁自然；若强调“相互匹配”，也可译为 “fit” 或 “match”. | This app needs to adapt to both iOS and Android platforms.<br>（这个应用需要适配 iOS 和 Android 两大平台。） |
...
| Reference | 参考 | “参考”在中文中多用于文档、编程、学术或技术场景，表示可供查阅、借鉴的资料或信息。在英语中，最标准对应词为 “reference”，尤其在编程（如 API reference）、论文（如 references 部分）或系统提示（如 “for reference”）中直接使用。若强调“供参考”，可译为 “for your reference” 或 “as a reference”. | 请参考下面的文档完成配置。<br>→ Please complete the configuration with reference to the document below.<br>或者：仅供参考。<br>→ For your reference only. |
...
| unified style / uniform style | 统一样式 | "统一样式"常指使视觉或格式保持一致，在设计、编程（如CSS）、文档排版或UI领域中通常译为"unified style"或更专业的"uniform style"。在某些上下文中（如前端开发）也可直接译为"unify the style"或"standardize styling"。此处给出最常见且自然的翻译"unified style / uniform style"。 | 为了提升品牌形象，我们需要将所有宣传材料的统一样式。<br>→ To enhance the brand image, we need to adopt a unified style for all promotional materials. |
...
| Original | Translation | Explanation | Example Sentence |
| --- | --- | --- | --- |
| complete / fill in / autocomplete | 补全 | “补全”在中文中常用于编程、表单或搜索场景，指自动或手动地将不完整的内容填充完整。在英语技术语境中，最常见对应词为 “autocomplete”（如代码补全、输入补全）或 “complete”（动词形式）；在表单场景中也常用 “fill in”。根据上下文灵活选择，此处提供最通用技术译法。 | 编辑器会自动补全代码。<br>→ The editor will autocomplete the code.<br>或者：请补全以下信息。<br>→ Please fill in the following information. |
